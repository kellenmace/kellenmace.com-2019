            ...
            <article id="text__code">
              ...
              <div>
                ...
                <pre>Here is some preformatted text.
                  Some code may go in here, for instance.
                </pre>
              </div>
              <footer><p><a href="#top">[Top]</a></p></footer>
            </article>
          ...
          <section id="forms">
            ...
            <form>
              <fieldset id="forms__input">
                ...
                <p>
                  <label for="input__text3" className="error">Error</label>
                  <input id="input__text3" className="is-error" type="text" placeholder="Text Input" />
                </p>
                <p>
                  <label for="input__text4" className="valid">Valid</label>
              ...
              <fieldset id="forms__radio">
                ...
                <ul className="list list--bare">
                  <li><label for="radio1"><input id="radio1" name="radio" type="radio" className="radio" checked="checked" /> Option 1</label></li>
                  <li><label for="radio2"><input id="radio2" name="radio" type="radio" className="radio" /> Option 2</label></li>
